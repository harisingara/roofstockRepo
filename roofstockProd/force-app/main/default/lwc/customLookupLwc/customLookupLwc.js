...
export default class CustomLookupLwc extends LightningElement {
    ...
    @api defaultRecordId = '';
    @api sFilterObjectFieldApiName = '';
    @api sFilterObjectRecordId = '';
   ...
   // initial function to populate default selected lookup record if defaultRecordId provided  
    connectedCallback(){
         if(this.defaultRecordId != ''){
            fetchDefaultRecord({ recordId: this.defaultRecordId , 'sObjectApiName' : this.sObjectApiName, 'sFilterObjectFieldApiName' : this.sFilterObjectFieldApiName, 'sFilterObjectRecordId' : this.sFilterObjectRecordId })
            .then((result) => {
                if(result != null){
    ...
    @wire(fetchLookupData, { searchKey: '$searchKey' , sObjectApiName : '$sObjectApiName', sFilterObjectFieldApiName : '$sFilterObjectFieldApiName', sFilterObjectRecordId : '$sFilterObjectRecordId' })
     searchResult(value) {
